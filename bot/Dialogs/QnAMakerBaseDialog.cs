...
namespace Microsoft.BotBuilderSamples.Dialogs
{
    ...
    public class QnAMakerBaseDialog : QnAMakerDialog
    {
        ...
        public const string DefaultNoAnswer = "âÒìöÇ™å©Ç¬Ç©ÇËÇ‹ÇπÇÒÇ≈ÇµÇΩ";
        public const string DefaultCardTitle = "Ç‡ÇµÇ©ÇµÇƒÅH";
        public const string DefaultCardNoMatchText = "Ç±Ç±Ç…ÇÕÇ†ÇËÇ‹ÇπÇÒ";
